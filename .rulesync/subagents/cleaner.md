...
targets: ["*"]
description: >-
  Code quality specialist focused on removing tech debt, dead code, and AI-generated
  slop. Enforces simplicity through deletion and refactoring. Can be invoked explicitly
  or autonomously during refactoring.
claudecode:
  model: inherit
---
