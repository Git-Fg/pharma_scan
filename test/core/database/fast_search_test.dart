...
void main() {
  ...
  group('Fast Search Test - In-Memory DB', () {
    ...
    test('should find search candidates after aggregation', () async {
      ...
      // WHY: nomCanonique is the parsed canonical name (principle + dosage), not the brand name
      // Both ELIQUIS and APIXABAN ZYDUS will have the same nomCanonique: "APIXABAN 5 mg"
      // We verify that:
      // 1. Both candidates are found (2 candidates for 2 medications)
      // 2. They share the same group
      // 3. They have the same common principle
      // 4. One is princeps, one is generic
