...
import 'package:pharma_scan/features/history/presentation/providers/history_provider.dart';
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return ShadSheet(
      title: Row(
        children: [
          const Expanded(
            child: Text(Strings.historyTitle),
          ),
                  ...
                  return ListView.separated(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      final showPrincepsRef =
                          princepsRef != null && princepsRef.trim().isNotEmpty;
    ...
    final confirmed = await showShadDialog<bool>(
      ...
      builder: (dialogContext) => ShadDialog.alert(
        ...
        description: const Padding(
          ...
          child: Text(Strings.historyClearConfirmDescription),
        ),
        actions: [
          ShadButton.outline(
