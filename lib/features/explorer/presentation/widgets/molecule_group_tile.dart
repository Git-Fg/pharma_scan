// lib/features/explorer/widgets/molecule_group_tile.dart
...
class MoleculeGroupTile extends HookWidget {
  ...
  Widget build(BuildContext context) {
    ...
    // Sort groups by princepsReferenceName using natural sort
    ...
    // Extract unique princeps names (already sorted from sortedGroups)
  ...
  List<String> _splitNatural(String input) {
    ...
    for (var i = 0; i < input.length; i++) {
      final char = input[i];
      // Check if character is part of a number (digit, comma, or dot)
...
extension _StringNumeric on String {
  bool get isNumeric {
    ...
    // Check if string represents a number (handles decimal separators)
