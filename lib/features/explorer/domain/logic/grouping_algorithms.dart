...
String normalizeCommonPrincipes(String commonPrincipes) {
...
String formatPrinciples(String principles) {
...
String _calculateDominantPrinceps(List<GenericGroupEntity> groups) {
...
List<Object> groupByCommonPrincipes(List<GenericGroupEntity> items) {
  ...
  for (final item in items) {
    ...
    if (groupingKey.length <= 2 || suspiciousPrincipes.contains(groupingKey)) {
      groupingKey = 'UNIQUE_${item.groupId}';
    }
