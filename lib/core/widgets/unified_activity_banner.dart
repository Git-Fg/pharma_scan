...
class UnifiedActivityBanner extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Padding(
      padding: .fromLTRB(spacing.md, spacing.xs, spacing.md, spacing.xs),
      child: alert,
    );
  }
    ...
    return Column(
      ...
      children: [
        ...
        if (secondaryStatus != null) ...[
          Gap(spacing.xs / 2),
          Text(secondaryStatus!, style: context.typo.small),
        ],
        if (effectiveProgress != null || indeterminate) ...[
          ...
          Gap(spacing.xs / 2),
          Text(progressSummary, style: context.typo.small),
        ],
